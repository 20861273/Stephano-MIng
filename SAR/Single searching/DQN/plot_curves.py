...
def plot_learning_curves(scores, filename, ts, pr, nr, per, nsr, ms, lr, dr, er):
...
plot_learning_curves(rewards, filename, tss, prs, nrs, pers, nsrs, mss, lrs, drs, ers)